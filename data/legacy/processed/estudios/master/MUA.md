---
título: "Máster Universitario en Acuicultura"
acrónimo: MUA
tipo: Máster, Interuniversitario
campus: Campus de Valencia
modalidad: Presencial
centros: Dpto. de Ciencia Animal
ramas: Ciencias
...
> ⚠️ No se pudo obtener "Inicio" (https://www.upv.es/estudios/master/mua/)
...
Materia: **P**atología e inmunología****  
 Créditos mínimos: 6 | Carácter: Obligatorio

Materia: **C**alidad del agua****  
 Créditos mínimos: 3 | Carácter: Obligatorio

Materia: **F**isiología aplicada****  
 Créditos mínimos: 3 | Carácter: Obligatorio

Materia: **Z**oología aplicada****  
 Créditos mínimos: 3 | Carácter: Obligatorio

Materia: **D**iseño y gestión de instalaciones****  
 Créditos mínimos: 4 | Carácter: Obligatorio

Materia: **I**ngeniería de sistemas****  
 Créditos mínimos: 4 | Carácter: Obligatorio

Materia: **R**eproducción****  
 Créditos mínimos: 5 | Carácter: Obligatorio

Materia: **C**alidad del producto****  
 Créditos mínimos: 3 | Carácter: Obligatorio

Materia: **N**utrición y alimentación****  
 Créditos mínimos: 5 | Carácter: Obligatorio

### Módulo 2. Módulo optativo : 18 ECTS optativos

Materia: **I**ntroducción a la acuicultura****  
 Créditos mínimos: 2 | Carácter: Optativo

Materia: **Ú**ltimos avances en acuicultura****  
 Créditos mínimos: 3 | Carácter: Optativo

Materia: **S**istemas de producción: moluscos****  
 Créditos mínimos: 2 | Carácter: Optativo

Materia: **S**istemas de producción: cultivos auxiliares****  
 Créditos mínimos: 2 | Carácter: Optativo

Materia: **D**iagnóstico y control de enfermedades****  
 Créditos mínimos: 4 | Carácter: Optativo

Materia: **A**cuicultura sostenible****  
 Créditos mínimos: 3 | Carácter: Optativo

Materia: **S**istemas de producción: peces continentales y tropicales****  
 Créditos mínimos: 3 | Carácter: Optativo

Materia: **S**istemas de producción: peces marinos****  
 Créditos mínimos: 3 | Carácter: Optativo

Materia: **I**niciación a la investigación en acuicultura (orientación investigadora)****  
 Créditos mínimos: 6 | Carácter: Optativo

Materia: **P**rácticas externas (orientación profesional)****  
 Créditos mínimos: 6 | Carácter: Optativo  
...
Materia: **T**rabajo fin de máster****  
...
| **Titulación** | Máster Universitario en Acuicultura |
| **Tipo** | Máster |
...
| --- | --- | --- | --- | --- |
| 36,00 | 18,00 | 0,00 | 6,00 | 60,00 |

(\*) Dentro de esta Optatividad el alumnado podrá cursar hasta un máximo de 6 créditos de prácticas externas curriculares.

## MÓDULO 1:  Módulo ObligatorioCréditos Mínimos : 36Carácter: Obligatorio

## MATERIA. :  Patología e InmunologíaCréditos Mínimos : 6Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32846 | Patología e Inmunología (UV) | Obligatorio | 1 | A | 6 |  |

## MATERIA. :  Calidad del AguaCréditos Mínimos : 3Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32847 | Calidad del Agua (UV) | Obligatorio | 1 | A | 3 |  |

## MATERIA. :  Fisiología AplicadaCréditos Mínimos : 3Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32848 | Fisiología Aplicada (UV) | Obligatorio | 1 | A | 3 |  |

## MATERIA. :  Zoología AplicadaCréditos Mínimos : 3Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32850 | Zoología Aplicada (UV) | Obligatorio | 1 | A | 3 |  |

## MATERIA. :  Diseño y Gestión de InstalacionesCréditos Mínimos : 4Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32851 | Diseño y Gestión de Instalaciones | Obligatorio | 1 | B | 4 |  |

## MATERIA. :  Ingeniería de SistemasCréditos Mínimos : 4Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32852 | Ingeniería de Sistemas | Obligatorio | 1 | B | 4 |  |

## MATERIA. :  ReproducciónCréditos Mínimos : 5Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32853 | Reproducción | Obligatorio | 1 | A | 5 |  |

## MATERIA. :  Calidad del ProductoCréditos Mínimos : 3Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32849 | Calidad del Producto | Obligatorio | 1 | B | 3 |  |

## MATERIA. :  Nutrición y AlimentaciónCréditos Mínimos : 5Carácter: Obligatorio

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32854 | Nutrición y Alimentación | Obligatorio | 1 | A | 5 |  |

## MÓDULO 2:  Módulo OptativoCréditos Mínimos : 18Carácter: Optativo

## MATERIA. :  Introducción a la AcuiculturaCréditos Mínimos : 2Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32842 | Introducción a la Acuicultura (UV) | Optativo | 1 | A | 2 |  |

## MATERIA. :  Últimos Avances en AcuiculturaCréditos Mínimos : 3Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32843 | Últimos Avances en Acuicultura (UV) | Optativo | 1 | B | 3 |  |

## MATERIA. :  Sistemas de Producción: MoluscosCréditos Mínimos : 2Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32844 | Sistemas de Producción: Moluscos (UV) | Optativo | 1 | B | 2 |  |

## MATERIA. :  Sistemas de Producción: Cultivos AuxiliaresCréditos Mínimos : 2Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32845 | Sistemas de Producción: Cultivos Auxiliares (UV) | Optativo | 1 | B | 2 |  |

## MATERIA. :  Diagnóstico y Control de EnfermedadesCréditos Mínimos : 4Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32837 | Diagnóstico y Control de Enfermedades (UV) | Optativo | 1 | B | 4 |  |

## MATERIA. :  Acuicultura SostenibleCréditos Mínimos : 3Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32836 | Acuicultura Sostenible | Optativo | 1 | B | 3 |  |

## MATERIA. :  Sistemas de Producción: Peces Continentales y TropicalesCréditos Mínimos : 3Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32838 | Sistemas de Producción: Peces Continentales y Tropicales | Optativo | 1 | B | 3 |  |

## MATERIA. :  Sistemas de Producción: Peces MarinosCréditos Mínimos : 3Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32839 | Sistemas de Producción: Peces Marinos | Optativo | 1 | B | 3 |  |

## MATERIA. :  Iniciación a la Investigación en Acuicultura (Orientación Investigadora)Créditos Mínimos : 6Carácter: Optativo

| Código | Asignatura | Tipo | Curso | Sem. | ECTS | Ofe. |
| --- | --- | --- | --- | --- | --- | --- |
| 32840 | Iniciación a la Investigación en Acuicultura (orientación investigadora) | Optativo | 1 | B | 6 |  |

## MATERIA. :  Prácticas Externas (Orientación Profesional)Créditos Mínimos : 6Carácter: Optativo
...
## MÓDULO 3:  Módulo Trabajo Fin de MásterCréditos Mínimos : 6Carácter: Trabajo Fin Titulación

## MATERIA. :  Trabajo Fin de MásterCréditos Mínimos : 6Carácter: Trabajo Fin Titulación
...
Programa de becas de postgrado para titulados superiores españoles, para la ampliación de estudios en Universidades y Centros de Investigación españoles y extranjeros. El programa persigue la formación de futuros dirigentes, priorizando las áreas de economía y empresa, análisis económico del derecho, regulación y desregulación y análisis económico y jurídico de la competencia y los mercados.

### Fundación “La Caixa”

Becas para estudiantes españoles y portugueses que deseen realizar estudios de posgrado en el extranjero.

### Programa Fulbright

Ofrece becas para ciudadanos norteamericanos para realizar estudios de postgrado en España y becas para españoles para cursar estudios de posgrado en universidades de Estados Unidos en cualquier disciplina.
